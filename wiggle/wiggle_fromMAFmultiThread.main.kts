// Original: https://github.com/maize-genetics/BioKotlin/blob/master/src/main/kotlin/biokotlin/genome/wiggle_fromMAFmultiThread.kts
@file:DependsOn("org.biokotlin:biokotlin:0.08")
